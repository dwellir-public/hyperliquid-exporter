...
Monitors include: block times, consensus participation (QC/TC signatures with sliding windows), EVM blocks and gas, proposals, validator status and RTT, gossip/heartbeat activity, outbound peer discovery (via tcp_traffic), software version, replica command streaming, and round advances.
